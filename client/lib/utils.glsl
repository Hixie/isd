...
// the range is the range of q values (not output values, which are always 0..1)
// this is for one channel plus time; if you want to pass in x, y, and time, use noise3 variant
...
// the range is the range of q values (not output values, which are always 0..1)
// this is for one channel plus time; if you want to pass in x, y, and time, use fractalNoise3 variant
